...
public class J06006QuanLyBanHang2 {
        static class KH {
    ...
    static class HD {
        ...
        void update(long giaMua,long loi) {
            tt = Long.valueOf(soluong) * giaMua;
            ln = Long.valueOf(soluong) * loi;
        }
        @Override
        public String toString() {
            return soluong + " " + tt + " " + ln;
        }
    ...
    public static void main(String[] args) {
        ...
        for (HD a : lsHD) {
            ...
            if (mh != null) {
                a.update(mh.ban,mh.loi);
            }
        }
        lsHD.sort((HD a,HD b) -> {
            return Long.compare(b.ln, a.ln);
        });
        for (HD a : lsHD) {
